...
class Professional extends Component {
  ...
  onSubmit = e => {
    ...
    axios
      .post('https://mern-nav.herokuapp.com/api/professionals/profile', data)
      .then(res => {
        this.setState({
          name:'',
...
<div>
	...
	<option value="Yukon">Yukon</option>
          ...
          <div className="card-box">
            ...
            <input className="form-control" name="submit" value="Update Profile" type="submit" className="button-nav" />
          </div>
        </form>
